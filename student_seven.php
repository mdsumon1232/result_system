...
<head>
    ...
    <title>student list of class seven</title>
...
<body>
   ...
   <h2 class="text-center my-5 text-2xl font-bold">Student list of class seven</h2>
    <div>
        <?php 
        ...
        ";
          ...
          $select_data = "SELECT* FROM students_details WHERE class = 'seven' ";
