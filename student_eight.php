...
<head>
    ...
    <title>student list of class eight</title>
...
<body>
   ...
   <h2 class="text-center my-5 text-2xl font-bold">Student list of class eight</h2>
    <div>
        <?php 
        ...
        ";
          ...
          $select_data = "SELECT* FROM students_details WHERE class = 'eight' ";
